...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        SimpleDateFormat countdownFormat = new SimpleDateFormat(
                getString(R.string.countDownFormat), Locale.getDefault());
        ...
        long minutesTillBoarding = totalMinutesTillBoarding
                - TimeUnit.HOURS.toMinutes(hoursTillBoarding);
        String minutesCountdown = getString(R.string.countDownFormat,
                hoursTillBoarding,
                minutesTillBoarding);
        mBinding.textViewBoardingInCountdown.setText(minutesCountdown);
