...
public class TaskContentProvider extends ContentProvider {
    ...
    private final static int TASK_ID = 101;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        um.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS, TASKS);
        um.addURI(TaskContract.AUTHORITY, TaskContract.PATH_TASKS + "/#", TASK_ID);
